...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        <div class="card-title">
            <h3 class="card-label">Add Corporate User
    ...
    <form class="form" name="add-user" id="add-user" action="" method="post" enctype="multipart/form-data">
			    ...
			    <div class="row">
	                <div class="col-md-6">
                        ...
                        <div class="form-group" style="display: none;">
						    ...
						    <input type="password" name="password" id="password" value="123456789" class="form-control"  placeholder="Enter Password"/>
                        </div>
                        {{-- <div class="form-group">
                        ...
                        <div class="form-group">
						    ...
						    <input type="text" name="jobposition" id="jobposition" value="" class="form-control"  placeholder="Enter Job position"/>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group" style="display: none;">
						    ...
						    <input type="password" name="confirm_password" id="confirm_password" value="123456789" class="form-control"  placeholder="Enter Confirm Password"/>
                        </div>
        ...
        <div class="card-footer">
            ...
            <input type="hidden" name="typeuser" id="typeuser" value="4" />
    ...
    $( "#save" ).click(function() {
	    ...
	    $("#add-user").validate({
	        ...
	        messages: {
                ...
                jobposition: {  required: "Please enter Job position" },
	        },
		    submitHandler: function(form,event) {
			    ...
			    $.ajax({
				    url: '{{ url('admin/corporate/create-user') }}',
				    type: "POST",
				    data:formData,
				    contentType: false,
				    ...
				    success: function( response ) {
					    if(response.status == "200"){
                            ...
                            window.location.href = "{{ route('corporate.users.list')}}";
                        }else{
