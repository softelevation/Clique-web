...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        ...
        <div class="card-toolbar">
            ...
            <a href="{{ url('admin/corporate/create-user') }}" class="btn btn-primary font-weight-bolder mr-2">
                <i class="icon-2x text-white-50 flaticon-users-1"></i> Add User
            </a>
...
@section('scripts')
    ...
    $(function () {
            ...
            ajax: "{{ route('corporate.users.list') }}",
                columns: [
...
//***************************** Delete User ********************************/
        $('body').on('click', '.deleteuser', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: '{{ url("admin/corporate/users/destroy") }}',
                        type: "POST",
                        data:{id:user_id},
                        headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                        dataType: "json",
