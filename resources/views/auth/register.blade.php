        ...
        <div class="d-flex flex-column-fluid flex-center mt-30 mt-lg-0">
            ...
            <div class="login-form">
                ...
                <form class="form" name="add-user" id="add-user" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input class="form-control form-control-solid h-auto py-5 px-6" type="password" placeholder="Confirm password" id="confirm_password" name="confirm_password" autocomplete="off"/>
                    </div>
                    {{-- <div class="form-group">
                    ...
                    <div class="form-group d-flex flex-wrap flex-center">
                        <button type="submit" id="save" name="save" class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4">Submit</button>
