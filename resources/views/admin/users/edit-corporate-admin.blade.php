...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        <div class="card-title">
            <h3 class="card-label">Edit Corporate Admin
			    ...
			    <div class="row">
                                ...
                                <div class="col-lg-8 col-xl-9">
                                    <div class="image-input image-input-outline" id="kt_user_add_avatar">
                                        ...
                                        <div class="image-input-wrapper" style="background-image: url({{$storage_path}})"></div>
                                            ...
                                            <input type="file" name="avatar" value="{{$storage_path}}" id="avatarFile" accept=".png, .jpg, .jpeg" />
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <?php
                                $mobile1 = array();    
                               if($user_data->mobile != NULL || !empty($user_data->mobile))
                               {
...
<script>
    $( document ).ready(function() {
        ...
        $("#mobile").CcPicker();
        $("#mobile").CcPicker("setCountryByPhoneCode","{{ $mobile1[0] }}");
