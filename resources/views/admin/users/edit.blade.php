        ...
        <div class="container">
			<div class="row">
	            <div class="col-md-8">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="col-lg-8 col-xl-9">
                                <div class="image-input image-input-outline" id="kt_user_add_avatar">
                                    ...
                                    @endif
                                    <div class="image-input-wrapper edit-user-img" style="background-image: url({{$storage_path}})"></div>
                    ...
                    <div class="form-group">
						<label><i class="fas fa-briefcase"></i>Company Name</label>
						<div class="designation user-info"><i class="fas fa-briefcase"></i>{{$c_data['companyname']}}</div>
                    </div>

                    <div class="form-group">
						<label><i class="fas fa-briefcase"></i>Job Position</label>
						<div class="designation user-info"><i class="fas fa-briefcase"></i>{{$c_data['jobposition']}}</div>
                    </div>
                    <div class="form-group">
                        <label><i class="flaticon2-file"></i>Resume</label>
                        <div class="designation user-info">
                          <i class="far fa-file-pdf"></i>{{$profiledata->resume_file}}
                        </div>
                        <div class="designation user-info">
