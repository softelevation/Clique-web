...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        ...
        <div class="card-toolbar">
            ...
            <a href="{{ url('admin/create/individual-user') }}" class="btn btn-primary font-weight-bolder mr-2">
                <i class="icon-2x text-white-50 flaticon-users-1"></i>Add Individual User
            </a>
            <a href="{{ url('admin/create/corporate-user') }}" class="btn btn-primary font-weight-bolder mr-2">
                <i class="icon-2x text-white-50 flaticon-users-1"></i>Add Corporate User
            </a>
            {{-- <a href="{{ url('admin/create/corporate-admin') }}" class="btn btn-primary font-weight-bolder mr-2">
                <i class="ki ki-plus icon-sm"></i> Corporate Admin
            </a>
            <a href="{{ url('admin/create/system-admin') }}" class="btn btn-primary font-weight-bolder mr-2">
                <i class="ki ki-plus icon-sm"></i> System Admin
            </a> --}}
        </div>
    </div>
    <div class="card-body">
