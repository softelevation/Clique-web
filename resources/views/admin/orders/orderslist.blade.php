...
$(function () {
        ...
        var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'customer_details', name: 'customer_details',"width": "15%"},
                    {data: 'order_from', name: 'order_from',"width": "15%"},
                    {data: 'created_at', name: 'created_at',"width": "22%"},
                    {data: 'assign', name: 'assign',"width": "18%"},
                    {data: 'action', name: 'action', orderable: false, searchable: false,"width": "10%"},
                ]
            });


    $('body').on('click', '.is_delivered', function () {
        var order_id = $(this).data('id');
        
        Swal.fire({
            title: "Are you sure?",
            text: "Are you sure want to Delivered!",
            icon: "warning",
          ...
          cancelButtonColor: '#d33'
            ...
            if (result.value) {
                ...
                $.ajax({
                    url: '{{ url("admin/orders/delivered") }}',
                    type: "POST",
                    data:{id:order_id},
                    headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                    dataType: "json",
