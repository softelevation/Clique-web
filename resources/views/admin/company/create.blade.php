...
<div class="card card-custom">
    ...
    <form class="form" name="add-company" id="add-company" action="" method="post" enctype="multipart/form-data">
    <div class="card-body">
        <div class=" container ">
			<div class="row">
	            <div class="col-md-6">
                    <div class="form-group ">
						...
						<input type="text" id="name" name="name" value="" class="form-control"  placeholder="Enter Comapny name"/>
                    </div>
	            </div>
                <div class="col-md-6">
                    <div class="form-group">
...
if($("#add-company").length > 0) {
	$("#add-company").validate({
		...
		submitHandler: function(form,event) {
			...
			var myform = document.getElementById("add-company");
			var formData = new FormData(myform);
			$.ajax({
				url: '{{ url('admin/create-company') }}',
				type: "POST",
				data:formData,
				contentType: false,
