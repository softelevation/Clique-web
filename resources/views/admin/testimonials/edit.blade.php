...
<div class="card card-custom">
    ...
    <form class="form" name="add-page" id="add-page" action="" method="post" enctype="multipart/form-data">
			    ...
			    <div class="row">
	                <div class="col-md-8">
                        <div class="form-group ">
                            ...
                            <input type="text" id="name" name="name" value="{{$testimonialsdata->name}}" class="form-control"  placeholder="Enter Title"/>
                        </div>
	                </div>
                    <div class="col-md-8">
                        <div class="form-group">
						    <label>Tagline <span class="text-danger">*</span></label>
						    <input type="text" id="tagline" name="tagline" value="{{$testimonialsdata->tagline}}" class="form-control"  placeholder="Enter Tagline"/>
					    </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group">
						    <label>Description <span class="text-danger">*</span></label>
						    <textarea class="form-control" id="description" name="description" rows="3">{{$testimonialsdata->description}}</textarea>
					    </div>
                    </div>
                    <div class="col-md-8">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="col-lg-8 col-xl-9">
                                    <div class="image-input image-input-outline" id="kt_user_add_avatar">
                                        @if($testimonialsdata->image == '/user/default.png')
                                        <?php  $storage_path = asset('media/users/blank.png'); ?>
                                        @else
                                        <?php  $storage_path = asset('storage'.$testimonialsdata->image) ?>
                                        @endif
        ...
        <div class="card-footer">
            <input type="hidden" id="edit_testimonialsid" name="edit_testimonialsid" value="{{$testimonialsdata->id}}">
    ...
    if($("#add-page").length > 0) {
	    $("#add-page").validate({
		    ...
		    submitHandler: function(form,event) {
			    ...
			    $.ajax({
				    url: '{{ url('admin/update-testimonials') }}',
				    type: "POST",
				    data:formData,
				    contentType: false,
